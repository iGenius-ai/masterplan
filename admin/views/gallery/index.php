...
<head>
    ...
    <title>Manage Categories | Masterplan</title>
</head>
<body>
	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="<?php echo (BASE_URL . "admin/views/gallery/index.php"); ?>" class="active"><span class="las la-image"></span> <span>Manage Gallery</span></a></li>
									...
									<tbody>
										...
										<?php foreach ($years as $key => $year): ?>
											<tr>
												...
												<td style="width: 100px;"><a style="color: green;" href="edit.php?id=<?php echo $year["id"]; ?>"><span class="las la-edit"></span> Edit</a></td>
												<td style="width: 100px;"><a style="color: red;" href="edit.php?delete_id=<?php echo $year['id']; ?>"><span class="la la-trash"></span> Delete</a></td>
											</tr>
										<?php endforeach; ?>
