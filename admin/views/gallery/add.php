	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li><a href="<?php echo (BASE_URL . "admin/views/gallery/add.php"); ?>" class="active"><span class="las la-folder-open"></span> <span>Add Image Category</span></a></li>
	...
	<div class="main-content">
        ...
        <div class="profile-body">
          <div class="profile-container">
        			...
        			<h1 class="text-center">Add Image Category</h1>
							...
							<div class="form-step form-step-active">
								...
								<div class="">
									<input type="submit" name="add_imgYear" value="Add Category" class="btn">
								</div>
							</div>
            </form>
					</div>
