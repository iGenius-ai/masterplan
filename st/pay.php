      ...
      <ul>
        <?php if (isset($_SESSION['id'])): ?>
          <?php if (!empty($_SESSION['admin'])): ?>
            ...
            <li>
              <a href="<?php echo (BASE_URL . "st/profile.php"); ?>"><span class="las la-user"></span> <span>Profile</span></a>
            </li>
            <li>
        ...
        <?php endif; ?>
        <li>
          <a href="pay.php" class="active"><span class="las la-wallet"></span> <span>View Receipts</span></a></li>
        <li>
